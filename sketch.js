...
function preload(){
    ...
    obstacle5Img=loadImage("images/car8.png");

    obstacle6Img=loadImage("images/car6.png");

    obstacle7Img=loadImage("images/car7.png");

    obstacle8Img=loadImage("images/truck.png");
    ...
    drift=loadSound("sounda/drift.wav");
...
function setup(){
  ...
  info=createSprite(680,350,10,10);
...
function draw(){
  ...
  if(keyDown(RIGHT_ARROW) && keyDown("space")){
    drift.play();
    playerCar.rotation=45;
    playerCar.x=playerCar.x+0.5;
  }
